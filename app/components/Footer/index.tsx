...
const footer = () => {
    return (
        <div className="bg-black mt-2" id="first-section">
            <div className="mx-auto max-w-2xl pt-16 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4 flex flex-col items-center lg:items-start'>
                        <h3 className='text-white text-4xl font-semibold text-center leading-9 mb-4 lg:mb-20 lg:text-left'> Gobsan Tech House </h3>
            ...
            <div className="mx-auto max-w-2xl lg:max-w-7xl">
                <div className="pt-5 pb-5 px-4 sm:px-6 lg:px-4 border-solid border-t border-footer">
                    <div className="mt-4 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 xl:gap-x-8">
                        <div>
                            <h3 className='text-center md:text-start text-offwhite text-lg'>{new Date().getFullYear()} - All Rights Reserved by Gobsan Tech House</h3>
                        </div>
